...
const SurveyDashboard = ({ isAdmin }:any) => {
    ...
    const fetchDashboardData = async (teacherId = '') => {
      ...
      try {
        ...
        console.log("feedback",feedbackRes.data.data,"trend",trendRes.data.data,"distribution",distributionRes.data.data,"stats",statsRes.data.data)
      } catch (error) {
    ...
    return (
      <div className=" pt-6 space-y-4">
        ...
        <div className="bg-white globalCardStyle p-6 rounded-lg shadow">
          <h3 className="ch mb-4">Recent Feedback</h3>
