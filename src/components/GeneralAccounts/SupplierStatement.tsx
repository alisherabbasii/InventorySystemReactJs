    ...
    <div className="flex">
      ...
      <div className="w-3/4 p-8">
        ...
        <div className="p-6 bg-white rounded-lg shadow-md">
          <h2 className="text-xl font-semibold mb-4">Supplier Statement</h2>
        ...
        <div className="mt-6 bg-white shadow-md rounded p-4">
          ...
          <div className="flex justify-between mt-4">
            ...
            <div>
              ...
              {finalBalance < 0 ? (
                <span className="text-red-500">{finalBalance} (Receivable)</span>
              ) : (
                <span className="text-green-500">{finalBalance} (Payable)</span>
              )}
            </div>
          </div>
        </div>
